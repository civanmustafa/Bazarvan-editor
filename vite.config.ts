...
export default defineConfig(({ mode }) => {
      ...
      ['GEMINI_MODEL', 'GEMINI_PAID_MODEL', 'GEMINI_ALLOWED_MODELS', 'OPENAI_MODEL', 'OPENAI_ALLOWED_MODELS', 'PROVIDER_CREDENTIAL_VAULT_KEY', 'PROVIDER_ACCESS_ENCRYPTION_KEY', 'AI_SETTINGS_ENCRYPTION_KEY', 'CRAWLER_SETTINGS_ENCRYPTION_KEY', 'FIRECRAWL_API_URL', 'COMPETITOR_PREVIEW_CACHE_HOURS', 'N8N_INGEST_TOKEN', 'SUPABASE_SERVICE_ROLE_KEY', 'SUPABASE_URL', 'SUPABASE_ANON_KEY', 'VITE_SUPABASE_URL', 'VITE_SUPABASE_ANON_KEY', 'EDITOR_PUBLIC_URL', 'PUBLIC_EDITOR_URL', 'APP_BASE_URL', 'ALLOWED_API_ORIGINS', 'AI_MAX_PROMPT_CHARS', 'API_AUTH_CACHE_TTL_SECONDS', 'CLIENT_SITE_CRAWL_API_RATE_LIMIT', 'GEMINI_START_RATE_LIMIT_PER_MINUTE', 'GEMINI_PROGRESS_RATE_LIMIT_PER_MINUTE', 'GEMINI_CANCEL_RATE_LIMIT_PER_MINUTE', 'OPENAI_START_RATE_LIMIT_PER_MINUTE', 'ARTICLE_SAVE_MAX_BYTES', 'ARTICLE_SAVE_RATE_LIMIT_PER_MINUTE'].forEach((key) => {
