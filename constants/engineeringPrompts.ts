...
اكتب قبل كل بطاقة جملة أو جملتين فقط تلخصان سبب الاقتراح دون تكرار موضع البطاقة أو نصها أو عنوانها، ثم ضع علامة بطاقة التنفيذ فقط مثل:
...
* عند الحذف: لا ترسل بطاقة بنص فارغ. استخدم replace_block لاستبدال المقطع الزائد بالصياغة النهائية بعد إزالة الحشو أو التكرار، أو بانتقال مختصر يحفظ المعنى إذا كان ضروريًا.
* استخدم عمليات الإضافة فقط إذا كان النص المقترح جديدًا وغير موجود أصلًا في المقال، وهذا الأمر غالبًا لا يحتاج إضافة.
