...
* عند الدمج: استخدم replace_block. إذا كان يمكن نسخ المقطعين المتداخلين حرفيًا معًا، اجعل targetText النص الكامل للمقطعين واجعل contentMarkdown النسخة المدمجة النهائية. إذا لم يمكن ذلك، استبدل المقطع الأضعف أو الأكثر تكرارًا بنسخة مختصرة تحفظ المعلومات الفريدة وتربطه بالقسم الأنسب.
