...
المخرجات المطلوبة:
اكتب ملخصًا بسيطًا من جملة أو جملتين يوضح لماذا تحتاج الخاتمة إلى هذا التحسين، ثم ضع علامة بطاقة تنفيذ واحدة مثل [[PATCH:patch_1]] لعرض الخاتمة المحسّنة الجاهزة للاستبدال.
...
- قبل كل بطاقة، اكتب ملخصًا بسيطًا من جملة أو جملتين يوضح سبب الاقتراح دون عرض النص الجاهز.
...
أخرج فقط:
1. ملخصًا بسيطًا من جملة أو جملتين يوضح سبب اقتراح الاستبدال.
2. مكان الاستبدال داخل المحرر نصيًا.
3. علامة بطاقة تنفيذ واحدة مثل [[PATCH:patch_1]] لعرض النسخة المحسّنة الجاهزة للاستبدال.
...
أخرج فقط:
1. ملخصًا بسيطًا من جملة أو جملتين يوضح سبب اقتراح الإضافة دون عرض "الفكرة" كعنوان مستقل.
2. مكان الإضافة المقترح داخل المقال نصيًا.
3. علامة بطاقة تنفيذ واحدة مثل [[PATCH:patch_1]] لعرض النص الجاهز للإضافة.
...
- اكتب قبل البطاقة ملخصًا بسيطًا من جملة واحدة يوضح لماذا يفيد هذا السؤال القارئ أو نية البحث.
- اكتب مكان إضافته داخل المقال نصيًا.
...
- اكتب قبل البطاقة ملخصًا بسيطًا من جملة أو جملتين يوضح الفجوة وسبب اقتراح النص.
- اكتب مكان النص في المحرر نصيًا.
...
- اكتب قبل البطاقة ملخصًا بسيطًا من جملة أو جملتين يوضح سبب التصحيح.
- اكتب مكان النص في المحرر نصيًا.
- ضع علامة تنفيذ واحدة بصيغة [[PATCH:patch_1]] أو [[PATCH:patch_2]].
...
* اكتب reason كسبب مختصر لإضافة النص أو استبداله.
* اكتب title باسم البند أو عنوان القسم فقط؛ واجهة البطاقة ستعرض نوع العملية إضافة أو استبدال.
* داخل التقرير، ضع قبل كل بطاقة ملخصًا بسيطًا من جملة أو جملتين يوضح سبب الاقتراح، ثم ضع علامة [[PATCH:patch_1]] في موضع النص المقترح حتى تظهر بطاقة الموضع والنسخ والاستبدال في مكانها الصحيح.
* لا تعرض عناوين "الفكرة" أو "سبب أهميتها" أو "سبب أهمية إضافتها" داخل analysisMarkdown عند وجود بطاقة تنفيذ؛ اجعل السبب المختصر داخل ملخص قبل البطاقة وداخل حقل reason.
...
- أين أطبقه؟
- لماذا مهم؟
- ملخصًا قصيرًا قبل بطاقة التنفيذ إذا كان هناك نص جاهز قابل للتطبيق.
...
- قبل كل بطاقة تنفيذ، اكتب ملخصًا بسيطًا من جملة أو جملتين يوضح سبب الاقتراح.
- لا تستخدم عناوين "الفكرة" أو "سبب أهميتها" أو "سبب أهمية إضافتها" عند وجود بطاقة تنفيذ.
...
سبب الاقتراح:
[جملة أو جملتان توضحان لماذا يفيد التحويل القارئ أو SEO/AEO/GEO/LLM]
...
- مكان القسم:
   ...
   - الإجراء المقترح:
   - ملخص قصير قبل البطاقة يوضح سبب الاستبدال.
...
- ملخص بسيط يوضح سبب اقتراح الإضافة دون استخدام عنوان "الفكرة" أو "سبب أهميتها".
...
- قبل كل بطاقة، اكتب ملخصًا بسيطًا من جملة أو جملتين يوضح سبب الاقتراح.
- لا تستخدم عناوين "الفكرة" أو "سبب أهميتها" أو "سبب أهمية إضافتها" عند وجود بطاقة تنفيذ.
- إذا كان المقترح تعديلًا أو توسيعًا أو تحسينًا أو إعادة صياغة أو تصحيحًا لفقرة أو قسم أو جملة موجودة أصلًا في النص، فاستخدم replace_block وليس أي عملية إضافة.
- استخدم عمليات الإضافة فقط عندما يكون النص المقترح جديدًا وغير موجود أصلًا في المقال.
...
- قبل كل بطاقة، اكتب ملخصًا بسيطًا من جملة أو جملتين يوضح سبب إضافة الكيان أو السؤال.
