...
export const CLIENT_CENTER_AUTOMATIC_LINK_INSERTION_MIGRATION = '20260830020000_automatic_internal_link_insertion.sql';
export const CLIENT_CENTER_REQUIRED_MIGRATION = CLIENT_CENTER_AUTOMATIC_LINK_INSERTION_MIGRATION;
