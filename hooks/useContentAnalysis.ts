...
const STRUCTURE_ANALYSIS_TITLE_KEYS = {
  ...
  callToActionHeading: 'عنوان الإجراء',
  callToActionWordCount: 'طول دعوة اتخاذ اجراء',
  callToActionParagraphsSentences: 'فقرات وجمل دعوة اتخاذ اجراء',
  callToActionBulletList: 'قائمة نقطية',
  callToActionFinalSentence: 'فقرة إجراء',
