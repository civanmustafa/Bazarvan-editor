...
إذا سبق أن نفّذت الترحيلين الأول والثاني، فلا تعِد تنفيذهما؛ نفّذ الترحيل الثالث الجديد فقط قبل تحديث الواجهة والخادم. لا يحتاج الترحيل الثالث إلى عامل PM2 أو مفتاح جديد. بعد النشر، يعيد `/readyz` حالة HTTP 503 إذا كانت جداول مركز العملاء أو أعمدة الزحف أو جداول الربط الداخلي المطلوبة غير متوفرة.
