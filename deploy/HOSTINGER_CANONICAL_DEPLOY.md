...
## ترحيل المرحلة الأولى من مركز العملاء
...
ينشئ هذا الترحيل السجلات المركزية للعملاء والدومينات وتعيين الموظفين وصفحات الموقع ومهام الزحف المستقبلية. مصدر صفحات العميل مستقل تمامًا عن مقالات المحرر. لا يتضمن الترحيل حقول الشعار أو أسلوب الكتابة أو المصطلحات أو الخدمات أو الجمهور أو الأسواق أو ملاحظات المسؤول.

نفّذ الترحيل مرة واحدة قبل تحديث الخادم. بعد نشر الخادم، يعيد `/readyz` حالة HTTP 503 إذا كانت جداول مركز العملاء أو أعمدتها المطلوبة غير متوفرة.
