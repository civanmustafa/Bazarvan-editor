...
إذا سبق أن نفّذت الترحيلات الأربعة الأولى، فلا تعِد تنفيذها؛ نفّذ الترحيل الخامس الجديد فقط قبل تحديث الواجهة والخادم. لا يحتاج الترحيل الخامس إلى مفتاح ذكاء اصطناعي أو Search Console أو عملية PM2 جديدة. بعد النشر، يعيد `/readyz` حالة HTTP 503 إذا كانت جداول مركز العملاء أو أعمدة الزحف أو جداول الربط الداخلي أو الفهرس الخوارزمي أو سجل اقتراحات المحرر المطلوبة غير متوفرة.
