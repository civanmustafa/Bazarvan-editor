...
إذا سبق أن نفّذت الترحيلات الثلاثة الأولى، فلا تعِد تنفيذها؛ نفّذ الترحيل الرابع الجديد فقط قبل تحديث الواجهة والخادم. لا يحتاج الترحيل الرابع إلى مفتاح ذكاء اصطناعي أو Search Console أو عملية PM2 جديدة؛ عامل زحف مركز العملاء الحالي يبني ملف الصفحة تلقائيًا بعد نجاح الزحف. بعد النشر، يعيد `/readyz` حالة HTTP 503 إذا كانت جداول مركز العملاء أو أعمدة الزحف أو جداول الربط الداخلي أو الفهرس الخوارزمي المطلوبة غير متوفرة.
