...
تضيف هذه الترحيلات جلسات دائمة، وخطوات قابلة للاستئناف، وإدراج المقالة بعد المراجعة، وتسجيل النتائج الخارجية، ومنع تشغيل أكثر من جلسة نشطة، وتقارير جودة حتمية ذات إصدارات مع تتبع محاولات الإصلاح.

يجب تنفيذ الترحيلات الستة كلها قبل نشر إصدار الخادم المقابل. يعيد فحص الجاهزية `/readyz` حالة HTTP 503 إذا لم يكن مخطط قاعدة البيانات المطلوب لنظام كتابة المقالة متوفرًا.
