...
ينشئ الترحيل الأول السجلات المركزية للعملاء والدومينات وتعيين الموظفين وصفحات الموقع ومهام الزحف. ويضيف الترحيل الثاني حقول الاستخراج ودوال قائمة الزحف الدائمة اللازمة للمرحلتين الثانية والثالثة. مصدر صفحات العميل مستقل تمامًا عن مقالات المحرر، والزحف برمجي ولا يستخدم الذكاء الاصطناعي أو Search Console. لا تتضمن الترحيلات حقول الشعار أو أسلوب الكتابة أو المصطلحات أو الخدمات أو الجمهور أو الأسواق أو ملاحظات المسؤول.

إذا سبق أن نفّذت الترحيل الأول، فلا تعِد تنفيذه؛ نفّذ الترحيل الثاني فقط قبل تحديث الخادم. بعد النشر، يعيد `/readyz` حالة HTTP 503 إذا كانت جداول مركز العملاء أو أعمدة الزحف المطلوبة غير متوفرة.
