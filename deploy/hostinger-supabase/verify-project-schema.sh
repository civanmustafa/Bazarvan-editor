...
readonly ARTICLE_COMPETITOR_SOURCE_POLICY="$(sql_scalar "select count(*) = 2 from information_schema.columns where table_schema = 'public' and table_name = 'article_competitors' and column_name in ('source_class','content_weight')")"
