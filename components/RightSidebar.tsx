...
المطلوب:
استخرج محتوى الصفحة المهم فقط، ثم نظّمه كخريطة أفكار تحريرية مرتبة حسب بنية الصفحة.
لا تستخرج القوائم الجانبية أو الفوتر أو الهيدر أو الكوكيز أو التعليقات أو عناصر التنقل أو النصوص الدعائية المتكررة.

طبّق قواعد هندسية صارمة:
- ركّز على المحتوى التحريري الأساسي.
- استخرج العنوان، الوصف، H1، H2، H3، أهم الفقرات، وأهم عناصر القوائم.
- لا تخترع أي فكرة أو عنوان أو شرح غير موجود في الصفحة.
- لا تعتمد على الذاكرة أو المعرفة العامة أو توقعاتك عن الموضوع.
- كل تسمية أو نبذة مختصرة يجب أن تكون مستندة إلى نص ظاهر في الصفحة فقط.
- إذا لم تجد دليلا نصيا واضحا في الصفحة لفكرة معينة فلا تضفها.
- حافظ على ترتيب الصفحة قدر الإمكان من الأعلى إلى الأسفل.

طريقة التنظيم المطلوبة داخل حقل text:
- ابدأ بـ H1 إن وجد.
- لكل H2 مهم:
  اكتب العنوان بصيغة: "H2: العنوان"
  ثم اكتب الفقرات التابعة له بهذا النمط:
  "الفقرة الأولى: تسمية الفكرة - نبذة مختصرة من جملة واحدة مستخرجة من معنى النص الظاهر في الصفحة فقط."
  "الفقرة الثانية: تسمية الفكرة - نبذة مختصرة من جملة واحدة مستخرجة من معنى النص الظاهر في الصفحة فقط."
- لكل H3 تابع:
  اكتب العنوان بصيغة: "H3: العنوان"
  ثم اكتب الفقرات التابعة له بنفس النمط.
- إذا لم تكن العلاقة بين الفقرة والعنوان واضحة، ضعها تحت أقرب عنوان سابق واضح فقط.
- لا تكتب شرحا عاما خارج هذا التنظيم.

طريقة ملء الحقول:
- headings.h1 و headings.h2 و headings.h3: العناوين كما تظهر في الصفحة قدر الإمكان.
- paragraphs: اجعل كل عنصر بصيغة "تسمية الفكرة - نبذة مختصرة" بناء على الفقرة الأصلية فقط.
- listItems: اجعل كل عنصر بصيغة "تسمية العنصر - نبذة مختصرة" إذا كانت عناصر القائمة مهمة.
- text: التنظيم الكامل حسب H2/H3 والفقرات كما هو موضح أعلاه.
- wordCount: عدد كلمات النص المنظم في حقل text.
