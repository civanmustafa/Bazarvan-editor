...
export const ToolbarButton: React.FC<{ onClick: () => void | Promise<void>; title: string; isActive?: boolean; disabled?: boolean; children: React.ReactNode }> = ({ onClick, title, isActive = false, disabled = false, children }) => {
