    ...
    <div className="p-[0.1875rem]">
      {Object.entries(analysis)
        ...
        .map(([key, phrases]: [string, DuplicatePhrase[]]) => {
            ...
            return (
                <div key={key} className="mb-[0.125rem] bg-white dark:bg-[#2A2A2A] border border-gray-200 dark:border-[#3C3C3C] rounded-lg overflow-hidden transition-all duration-300">
                    <div
                    ...
                    >
                        ...
                        <div className="mt-[0.125rem] text-xs text-gray-500 dark:text-gray-400 flex justify-between items-center">
                        ...
                        <div className="w-full bg-gray-200 dark:bg-[#1F1F1F] rounded-full h-1.5 mt-[0.125rem] flex overflow-hidden">
